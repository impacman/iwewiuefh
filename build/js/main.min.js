...
/* harmony import */ var _modules_products__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/products */ "./js/modules/products.js");
...
/* harmony import */ var _modules_navPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/navPage */ "./js/modules/navPage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_navPage__WEBPACK_IMPORTED_MODULE_3__["navPage"])();
  Object(_modules_animationScroll__WEBPACK_IMPORTED_MODULE_2__["animationScroll"])();
  Object(_modules_products__WEBPACK_IMPORTED_MODULE_1__["products"])(); // afid();
  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_modals__WEBPACK_IMPORTED_MODULE_4__["modals"])(); // initCustomSelect();
    // initFormValidate();
  });
}); // ---------------------------------
...
/*!***************************************!*\
  !*** ./js/modules/animationScroll.js ***!
  \***************************************/
/*! exports provided: animationScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animationScroll", function() { return animationScroll; });
var animationScroll = function animationScroll() {
  var animtItems = document.querySelectorAll('[data-animation]');
  var header = document.querySelector('[data-header]');

  if (animtItems.length > 0) {
    var offsetEl = function offsetEl(el) {
    ...
    var animOnScroll = function animOnScroll() {
      ...
      for (var i = 0; i < animtItems.length; i++) {
        var animItem = animtItems[i];
        var animItemHeight = animItem.offsetHeight;
        var animItemOffset = offsetEl(animItem).top;
        var animStart = 4;
...
var modals = function modals() {
  var modalBtns = document.querySelectorAll('[data-open-modal]');
  var modalBtnsClose = document.querySelectorAll('[data-close-modal]');
  ...
  if (modalBtns.length > 0) {
    var bodyLock = function bodyLock() {
      var value = window.innerWidth - document.querySelector('[data-wrapper]').offsetWidth + 'px';
      body.style.paddingRight = value;
      body.style.overflow = 'hidden';
      header.style.width = "calc(100% - ".concat(value, ")");
    };
    ...
    modalBtns.forEach(function (btn) {
      var nameModal = btn.dataset.openModal;
      var currentModal = document.querySelectorAll('[data-modal]');
      btn.addEventListener('click', function () {
        currentModal.forEach(function (modal) {
...
var navPage = function navPage() {
  var openMenu = document.querySelector('[data-menu-open]');
  ...
  if (navMenu) {
    ...
    var removeActiveLink = function removeActiveLink() {
...
var products = function products() {
  var settings = {};
  var productsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-products-slider]', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["EffectCoverflow"], swiper__WEBPACK_IMPORTED_MODULE_0__["Lazy"], swiper__WEBPACK_IMPORTED_MODULE_0__["Thumbs"]],
    simulateTouch: true,
    touchRatio: 1,
    touchAngle: 45,
    grabCursor: true,
